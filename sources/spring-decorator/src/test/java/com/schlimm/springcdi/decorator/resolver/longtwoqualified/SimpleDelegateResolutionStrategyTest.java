...
public class SimpleDelegateResolutionStrategyTest {
	...
	public void testChaining_MyDecoratorLeadsToMyDelegate() {
		...
		try {
			decoratorInfo = new DecoratorInfo("myDecorator", beanFactory.getBeanDefinition("myDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwoqualified.MyDecorator"));
	...
	public void testChaining_MyDecorator2LeadsToMyDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("myDecorator2", beanFactory.getBeanDefinition("myDecorator2"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwoqualified.MyDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecoratorLeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("anotherDecorator", beanFactory.getBeanDefinition("anotherDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwoqualified.AnotherDecorator"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator2LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("anotherDecorator", beanFactory.getBeanDefinition("anotherDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwoqualified.AnotherDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
