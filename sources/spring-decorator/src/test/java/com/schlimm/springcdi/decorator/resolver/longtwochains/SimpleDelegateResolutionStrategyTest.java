...
public class SimpleDelegateResolutionStrategyTest {
	...
	public void testChaining_MyDecoratorLeadsToMyDelegate() {
		...
		try {
			decoratorInfo = new DecoratorInfo("myDecorator", beanFactory.getBeanDefinition("myDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longsinglechain.MyDecorator"));
	...
	public void testChaining_MyDecorator2LeadsToMyDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("myDecorator2", beanFactory.getBeanDefinition("myDecorator2"), Class.forName("com.schlimm.springcdi.decorator.resolver.longsinglechain.MyDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_MyDecorator3LeadsToMyDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("myDecorator3", beanFactory.getBeanDefinition("myDecorator3"), Class.forName("com.schlimm.springcdi.decorator.resolver.longsinglechain.MyDecorator3"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecoratorLeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("anotherDecorator", beanFactory.getBeanDefinition("anotherDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwochains.AnotherDecorator"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator2LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("anotherDecorator", beanFactory.getBeanDefinition("anotherDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwochains.AnotherDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator3LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("anotherDecorator", beanFactory.getBeanDefinition("anotherDecorator"), Class.forName("com.schlimm.springcdi.decorator.resolver.longtwochains.AnotherDecorator3"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
